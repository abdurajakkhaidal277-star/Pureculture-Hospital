...
export const translations: Translations = {
  ...
  selectSpecialist: { en: 'Select a Specialist', tl: 'Pumili ng Espesyalista' },
  selectDateTime: { en: 'Select Date & Time', tl: 'Pumili ng Petsa at Oras' },
  confirmBooking: { en: 'Confirm Booking', tl: 'Kumpirmahin ang Booking' },
  bookingConfirmed: { en: 'Booking Confirmed!', tl: 'Kumpirmado na ang Booking!' },
  availableDates: { en: 'Available Dates', tl: 'Mga Available na Petsa' },
  availableSlots: { en: 'Available Slots', tl: 'Mga Available na Slot' },
  dateTime: { en: 'Date & Time', tl: 'Petsa at Oras' },
  confirmAppointment: { en: 'Confirm Appointment', tl: 'Kumpirmahin ang Appointment' },
  editDetails: { en: 'Edit Details', tl: 'I-edit ang mga Detalye' },
  goToDashboard: { en: 'Go to Dashboard', tl: 'Pumunta sa Dashboard' },
  back: { en: 'Back', tl: 'Bumalik' },
  continue: { en: 'Continue', tl: 'Magpatuloy' },
  consultationFee: { en: 'Consultation Fee', tl: 'Bayad sa Konsultasyon' },
  selectPaymentMethod: { en: 'Select Payment Method', tl: 'Pumili ng Paraan ng Pagbabayad' },
  unpaidBalance: { en: 'Unpaid Balance', tl: 'Hindi pa Bayad na Balanse' },
  viewInvoices: { en: 'View Invoices', tl: 'Tingnan ang mga Invoice' },
  billingAndInvoices: { en: 'Billing & Invoices', tl: 'Billing at mga Invoice' },
  managePayments: { en: 'Manage your payments and view transaction history.', tl: 'Pamahalaan ang iyong mga bayad at tingnan ang kasaysayan ng transaksyon.' },
  paymentMethods: { en: 'Payment Methods', tl: 'Mga Paraan ng Pagbabayad' },
  payNow: { en: 'Pay Now', tl: 'Magbayad Na' },
  paymentSuccessful: { en: 'Payment successful!', tl: 'Matagumpay ang pagbabayad!' },
  gcash: { en: 'GCash', tl: 'GCash' },
  maya: { en: 'Maya', tl: 'Maya' },
  bankTransfer: { en: 'Bank Transfer', tl: 'Bank Transfer' },
  crypto: { en: 'Crypto', tl: 'Crypto' },
  securePayments: { en: 'Secure payments powered by PayMongo. Supports GCash, Maya, Bank Transfer, and Crypto.', tl: 'Ligtas na mga pagbabayad sa pamamagitan ng PayMongo. Sinusuportahan ang GCash, Maya, Bank Transfer, at Crypto.' },
  paymentInstructions: { en: 'Payment Instructions', tl: 'Mga Instruksyon sa Pagbabayad' },
  gcashInstructions: { en: 'Please send the exact amount to GCash: 0916 432 4390 (Zamboanga Puericulture Center). Then, upload your screenshot in the dashboard.', tl: 'Mangyaring ipadala ang eksaktong halaga sa GCash: 0916 432 4390 (Zamboanga Puericulture Center). Pagkatapos, i-upload ang iyong screenshot sa dashboard.' },
  mayaInstructions: { en: 'Please send the exact amount to Maya: 0916 432 4390. Then, upload your screenshot in the dashboard.', tl: 'Mangyaring ipadala ang eksaktong halaga sa Maya: 0916 432 4390. Pagkatapos, i-upload ang iyong screenshot sa dashboard.' },
  bankInstructions: { en: 'Bank: BDO | Account Name: Zamboanga Puericulture Center | Account Number: 001234567890. Please upload the deposit slip in the dashboard.', tl: 'Bank: BDO | Account Name: Zamboanga Puericulture Center | Account Number: 001234567890. Mangyaring i-upload ang deposit slip sa dashboard.' },
  cryptoInstructions: { en: 'Send USDT (TRC20) to: Txxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx. Please upload the transaction hash in the dashboard.', tl: 'Ipadala ang USDT (TRC20) sa: Txxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx. Mangyaring i-upload ang transaction hash sa dashboard.' },
  uploadProof: { en: 'Upload Proof of Payment', tl: 'I-upload ang Katibayan ng Pagbabayad' },
  paymentPending: { en: 'Payment Pending Verification', tl: 'Naghihintay ng Kumpirmasyon ang Bayad' },
